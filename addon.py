    ...
    for day_idx in range(7):
        ...
        if(day_idx==0):            
            ...
            if(day_idx==1):
                ...
                dowToShow = attDow+day_idx
                if(dowToShow>6):
                  dowToShow = dowToShow - 7
                liStyle = xbmcgui.ListItem(utils.dowArray[dowToShow] + " " + attDate.strftime("%d") + " " + utils.monthArray[int(attDate.strftime("%m"))-1])
